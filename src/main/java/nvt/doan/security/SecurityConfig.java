...
public class SecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http .csrf()
                .disable()
                .authorizeRequests()
                .antMatchers("/css/**","/fonts/**","/images/**","/js/**","/api/v1/booking/**","/api/v1/users/booking/**","/api/v1/users/pay/**","/api/v1/users/rate/**")
                .permitAll()
                ...
                .antMatchers("/view/users/favourites",
                        "/api/v1/users/account/**","/api/v1/dashboard/**").hasAnyRole("CUSTOMER","ADMIN")
                .and()
                .formLogin()
                .loginPage("/admin")
